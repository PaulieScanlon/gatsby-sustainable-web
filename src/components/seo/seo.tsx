...
export const Seo: FunctionComponent<ISeoProps> = ({
  ...
  return (
    <Helmet>
      ...
      {/* favicon */}
      <link rel="icon" type="image/png" sizes="16x16" href="images/favicon-16x16.png" data-react-helmet="true" />
      <link rel="icon" type="image/png" sizes="32x32" href="images/favicon-32x32.png" data-react-helmet="true" />
    </Helmet>
  )
}
